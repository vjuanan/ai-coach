...
async function run() {
    console.log('Generating Program: Rutina Antopanti 2026 FINAL');
    ...
    const { data: program, error: programError } = await supabase
        ...
        .insert({
            coach_id: COACH_ID,
            client_id: CLIENT_ID,
            name: 'Rutina Antopanti 2026 FINAL',
            ...
            if (dayNum === 1) { // Glúteo & Pierna
                ...
                blocks.push({
                    ...
                    config: {
                        rounds: 3,
                        movements: [
                            { name: 'Plancha', quantity: '30"', notes: 'abdomen duro, glúteos apretados, cuerpo en línea.' },
                            { name: 'Puente de Glúteo', quantity: '15', notes: 'empujá con talones, arriba apretá 1 segundo.' },
                            { name: 'Bird-Dog', quantity: '10 total', notes: 'espalda neutra, no rote la cadera.' },
                            { name: 'Sentadilla Aire', quantity: '10', notes: 'rodillas siguen la línea de los pies, tronco firme.' }
                        ]
                    },
                    format: 'STANDARD'
                });
                ...
                blocks.push({
                    ...
                    config: {
                        ...
                        restBetweenSets: '90s',
                        movements: [
                            { name: 'Sentadilla Búlgara', reps: bgReps, weight: bgWeight, notes: 'incliná levemente el tronco hacia adelante para foco en glúteo.' },
                            { name: 'Plancha Frontal', reps: '45-60"', weight: 'BW', notes: 'glúteos y abdomen apretados, no “cuelgues” la cintura.' }
                        ]
                    }
                });
                ...
                blocks.push({
                    ...
                    config: {
                        rounds: 3,
                        movements: [
                            { name: 'Flexiones Escapulares', quantity: '10', notes: 'brazos estirados, movés solo escápulas.' },
                            { name: 'Gato-Vaca', quantity: '10', notes: 'movilidad suave.' },
                            { name: 'Colgarse de Barra', quantity: '20"', notes: 'hombros abajo.' }
                        ]
                    },
                    format: 'STANDARD'
                });
                ...
                blocks.push({
                    ...
                    config: {
                        ...
                        restBetweenSets: '90s',
                        movements: [
                            { name: 'Remo Unilateral con Mancuerna', reps: rowReps, weight: rowWeight, notes: 'tirá el codo al bolsillo.' },
                            { name: 'Tríceps Trasnuca con Mancuerna', reps: triReps, weight: '8-10 kg', notes: 'codos cerrados.' }
                        ]
                    }
                });
                ...
                blocks.push({
                    ...
                    config: {
                        rounds: 3,
                        movements: [
                            { name: 'Zancada con Rotación', quantity: '6 total', notes: 'rotá desde torácica.' },
                            { name: 'Y-T-W', quantity: '10 total', notes: 'hombros lejos de orejas.' },
                            { name: 'Sentadilla Aire', quantity: '10', notes: 'truco firme.' }
                        ]
                    },
                    format: 'STANDARD'
                });
                ...
                blocks.push({
                    ...
                    config: {
                        ...
                        restBetweenSets: '90s',
                        movements: [
                            { name: 'Push-Ups', sets: puSets, reps: puReps, notes: 'cuerpo en tabla, codos 30-45°.' },
                            { name: 'Vuelos Posteriores', sets: rfSets, reps: rfReps, weight: 'Liviano', notes: 'abrí como alas.' }
                        ]
                    }
                });
                ...
                blocks.push({
                    ...
                    config: {
                        ...
                        restBetweenSets: '90s',
                        movements: [
                            { name: 'Step-Up Lateral', reps: stReps, weight: stWeight, notes: 'subí empujando solo con pierna arriba.' },
                            { name: 'Patada de Glúteo en Polea', sets: kbSets, reps: kbReps, weight: '5-10 kg', notes: 'pelvis quieta.' }
                        ]
                    }
                });
                ...
                blocks.push({
                    ...
                    config: {
                        rounds: 3,
                        movements: [
                            { name: 'Buenos Días', quantity: '10', notes: 'Enfoque en isquios.' },
                            { name: 'Sprawls', quantity: '5', notes: 'Dinámico.' },
                            { name: 'Sentadilla con Salto', quantity: '10', notes: 'Explosivo.' },
                            { name: 'Jumping Jacks', quantity: '20', notes: 'Ritmo constante.' }
                        ]
                    },
                    format: 'STANDARD'
                });
                ...
                blocks.push({
                    ...
                    name: 'Zona 2',
                    config: {
                        content: `35 min de Zona 2. Cue: podés hablar frases cortas sin ahogarte.`
                    }
                });
            }
