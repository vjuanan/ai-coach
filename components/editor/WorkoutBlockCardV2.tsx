...
const blockTypeStyles: Record<string, { color: string; label: string; hoverClass: string }> = {
    ...
    metcon: { color: 'border-l-4 border-l-sky-500 dark:border-l-sky-400', label: 'MetCon', hoverClass: 'hover:border-slate-300 dark:hover:border-slate-500 hover:shadow-none' },
